...
namespace EMRS.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Edit(int? status)
        {
            ViewBag.StatusMessage =
                   status == 0 ? "Your personal information has been updated."
                   : "";
            ...
            return View(new EditPatientModel(self));
        }
        ...
        public ActionResult Edit(EditPatientModel patientInfo)
        {
            if (ModelState.IsValid)
            {
                ...
                db.SaveChanges();
                return RedirectToAction("Edit", new { Status = 0 });
            }
